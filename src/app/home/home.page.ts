...
import { MeuProvedorService } from '../meu-provedor.service';
...
@Component({
  ...
  providers: [MeuProvedorService]
})
export class HomePage {
  public lista_post: Array<Object> = [];
  constructor(
    public navcontrol: NavController,
    public git: MeuProvedorService,
    public rota: Router
  ) {
    this.lista_post = [
      {
  ...
  showDetails(post) {
    console.log(post);
    this.navcontrol.navigateForward('/post-details');
  }
}
